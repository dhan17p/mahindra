...
service MyService {
    ...
    function actionTest(id : String, content : String)                                          returns String;
    function fold_data_attach(id : String)                                                      returns String;
    function workflowfun(vob_id : String, level : String, app_rej_by : String, status : String) returns String;
    function lineItemApproval(yoyitem : String)                                                 returns String;
}
