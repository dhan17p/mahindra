    ...
    return {
		...
		onAfterItemAdded: function(oEvent) {
			...
			if (!dialogOpen) {
				...
				var cdialog = new sap.m.Dialog({
					...
					endButton: new sap.m.Button({
						...
						press: function(oEvent) {
							debugger
							cdialog.close();
							var incomplete_items = sap.ui.getCore().byId("project1::parentObjectPage--fe::CustomSubSection::Attachment--uploadSet").destroyIncompleteItems();
				...
				vb1.addItem(new sap.ui.webc.main.Tree("treee",{ itemClick:async function (params) {debugger
					sap.ui.getCore().byId("treee").setFooterText(params.mParameters.item.sId);  
				  },
				  footerText:"Click on the folder to select path", 
				  headerText: "Folders", items: [new sap.ui.webc.main.TreeItem( "folder_1",{icon: "sap-icon://folder-full", text: "folder 1", items: [new sap.ui.webc.main.TreeItem( "folder_1-folder_1.1",{icon: "sap-icon://folder-full", text: "folder1.1", items: [new sap.ui.webc.main.TreeItem( "folder_1-folder_1.1-folder1.1.1",{icon: "sap-icon://folder-full", text: "folder1.1.1" })] })] }),
													new sap.ui.webc.main.TreeItem( "folder_2",{icon: "sap-icon://folder-full", text: "folder 2", items: [new sap.ui.webc.main.TreeItem( "folder_2-folder_2.1",{icon: "sap-icon://folder-full", text: "folder2.1" })] })] }));
